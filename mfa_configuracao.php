...
$provisioningUri = $setupSecret !== ''
    ? fullcare_mfa_provisioning_uri('FullCare', $account, $setupSecret)
    : '';
...
<main class="mfa-wrap">
    <section class="mfa-panel">
        ...
        <p class="mfa-lead">
            Use Google Authenticator, Microsoft Authenticator, 1Password ou outro aplicativo compatível com TOTP para proteger seu acesso ao FullCare.
        </p>
