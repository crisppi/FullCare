...
<div class="legacy-menu-shell">
    ...
    <div class="row legacy-menu-card">
        ...
        <div class="col lista_menu">
            ...
            <li>
                <a href="visitas/lista" <?php if ($_SESSION['nivel'] < 2) { ?> style="pointer-events: none"
            ...
            <li>
                <a href="contas/auditoria" <?php if ($_SESSION['nivel'] < 0) { ?> style="pointer-events: none"
            ...
            <li>
                <a href="dashboard-operacional"><i class="bi bi-activity"
            ...
            <li>
                <a href="inteligencia/previsao-faturamento"><i class="bi bi-graph-up"
            ...
            <hr>
            <li>
                <a href="internacoes/uti/alta" <?php if ($_SESSION['nivel'] < 2) { ?>
            ...
            <li>
                <a href="internacoes/reverter-alta" <?php if ($_SESSION['nivel'] < 2) { ?> style="pointer-events: none"
            ...
            <hr>
            <li>
                <a href="internacoes/drg" <?php if ($_SESSION['nivel'] < 2) { ?>
        ...
        <div class="col lista_menu">
            ...
            <li>
                <a href="usuarios/novo" <?php if ($_SESSION['nivel'] < 4) { ?> style="pointer-events: none"
                    ?<?php } ?>><span class="bi bi-person"
                        style="font-size: 1rem;margin-right:5px; color: rgb(155, 155, 76);"></span> Cadastro
                    Usuários</a>
            </li>
            <li>
                <a href="administracao/alterar-senha" <?php if ($_SESSION['nivel'] < 4) { ?> style="pointer-events: none"
                    ?<?php } ?>><span class="bi bi-person"
                        style="font-size: 1rem;margin-right:5px; color: rgb(15, 15, 76);"></span> Alterar senha</a>
            </li>
            <li>
                <a href="acomodacoes/nova" <?php if ($_SESSION['nivel'] < 2) { ?> style="pointer-events: none"
            ...
            <hr>
            <li>
                <a href="patologias/nova" <?php if ($_SESSION['nivel'] < 2) { ?> style="pointer-events: none"
                    ?<?php } ?>><span class="bi bi-heart-pulse"
                        style="font-size: 1rem;margin-right:5px; color: rgb(15, 215, 55);"></span> Cadastro
                    Patologia</a>
            </li>
            <li>
                <a href="antecedentes/novo" <?php if ($_SESSION['nivel'] < 2) { ?> style="pointer-events: none"
                    ?<?php } ?>><span class="bi bi-heart-pulse"
        ...
        <div style="margin-bottom:80px" class="col lista_menu">
            ...
            <hr>
            <li>
                <a href="pacientes/novo" <?php if ($_SESSION['nivel'] < 2) { ?> style="pointer-events: none"
                    ?<?php } ?>><span class="bi bi-person"
                        style="font-size: 1rem;margin-right:5px; color: rgb(155, 155, 76);"></span> Lista Pacientes</a>
            </li>
            <li>
                <a href="hospitais/novo" <?php if ($_SESSION['nivel'] < 4) { ?> style="pointer-events: none"
            ...
            <li>
                <a href="estipulantes/novo" <?php if ($_SESSION['nivel'] < 4) { ?> style="pointer-events: none"
                    ?<?php } ?>><span class="bi bi-building"
                        style="font-size: 1rem; margin-right:5px; color: rgb(145, 25, 177);"></span> Estipulante</a>
            </li>
            <li>
                <a href="seguradoras/nova" <?php if ($_SESSION['nivel'] < 4) { ?> style="pointer-events: none"
                    ?<?php } ?>><span class="bi bi-heart-pulse"
        ...
        <div class="col lista_menu">
            ...
            <hr>
            <li>
                <a href="gestao/fila-tarefas"><span class="bi bi-list-check"
                        style="font-size: 1rem;margin-right:5px; color: rgb(20, 120, 90);"></span> Fila de Tarefas</a>
            </li>
            <li>
                <a href="gestao/prorrogacoes-pendentes"><span class="bi bi-hourglass-split"
