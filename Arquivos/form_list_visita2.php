        ...
        <div class="container">
            ...
            <div class="row" id="table-content">
                ...
                <div class="container" style="display: flex;">
                    <div>
                        <a class="btn btn-success styled" style="background-color: #35bae1;font-family:var(--bs-font-sans-serif);box-shadow: 0px 10px 15px -3px rgba(0,0,0,0.1);border:none" href="/internacao/novo">Nova internação</a>
                    </div>
