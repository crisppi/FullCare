...
$sql = "
    SELECT
        h.nome_hosp,
        AVG(DATEDIFF(v.primeira_visita, i.data_intern_int)) AS media_dias,
        COUNT(*) AS total
...
<div class="bi-wrapper bi-theme">
    ...
    <div class="bi-panel">
        <h3>Tempo médio até primeira visita</h3>
                    ...
                    <?php else: ?>
                        <?php foreach ($rows as $row): ?>
                            <tr>
                                ...
                                <td><?= number_format((float)($row['media_dias'] ?? 0), 1, ',', '.') ?></td>
