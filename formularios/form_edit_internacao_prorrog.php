...
<div id="container-prorrog" >
    ...
    <div class="form-group col-sm-1" style="display:none">
        ...
        ?>
        <div>
            <input type="hidden" style="display:none" class="form-control" id="fk_internacao_pror" name="fk_internacao_pror"
                value="<?= $ultimoReg ?>">
        </div>

    </div>
    <div class="form-group col-sm-2" style="display:none">
        <input type="hidden" style="display:none" readonly class="form-control" id="data_inter_int2"
