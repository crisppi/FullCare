    ...
    <div id="table-content" class="listagem-table-wrap">
        ...
        <table class="table table-sm table-striped  table-hover table-condensed">
            ...
            <tbody>
                    ...
                    <td class="fc-list-action">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                ...
                                <li>
                                    <button class="dropdown-item"
                                        onclick="callValidarCapeante('<?= $intern['id_capeante'] ?>')">
                                        <i style="color:brown; margin-right:10px" class="bi bi-check"></i> Validar
                                    </button>
                                </li>
                        </div>
                    </td>
                ...
                <tr>
                    <td colspan="13" scope="row" class="col-id">
...
$(document).ready(function() {
    loadContent('list_internacao_cap_fin.php?&pag=<?php print 1 ?>&bl=<?php print 0 ?>');
});
</script>
