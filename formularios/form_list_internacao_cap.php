...
$url = 'list_internacao_cap.php?pesquisa_nome=' . $pesquisa_nome . '&pesquisa_pac=' . $pesquisa_pac . '&senha_fin=' . $senha_fin . '&encerrado_cap=' . $encerrado_cap . '&med_check=' . $med_check . '&enf_check=' . $enf_check . '&lote=' . $lote . '&adm_check=' . $adm_check . '&senha_int=' . $senha_int . '&data_intern_int=' . $data_intern_int . '&data_intern_int_max=' . $data_intern_int_max;
...
<div class="container-fluid form_container" id='main-container' style="margin-top:12px;">
    ...
    <!-- <div class="d-flex justify-content-between align-items-center" style="margin-bottom: 10px;">
        <h4 class="page-title" style="color: #3A3A3A; margin: 0;">Listagem - Capeantes</h4>
        <button class="btn btn-success"
            ...
            <i class="fa-solid fa-plus" style="font-size: 1rem; margin-right: 5px;"></i>Novo Capeante
        </button>
    </div> -->
    <div class="complete-table">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group col-sm-2" style="padding:2px !important">
                        <input class="form-control form-control-sm"
                            ...
                            placeholder="Digite o lote" value="<?= $lote ?>">
                    </div>
                    <div class="form-group col-sm-1" style="padding:2px !important">
                        <input class="form-control form-control-sm"
                            ...
                            placeholder="Digite o capeante" value="<?= $idcapeante ?>">
                    </div>
        ...
        <div>
            <div id="table-content">
                    ...
                    <tbody>
                        ...
                        <tr style="font-size:13px">
                            ...
                            <td scope="row">
                                ...
                                <a class="legenda-enfermagem" style="font-weight: bold"><span id=" boot-icon"
                            ...
                            <td class="action">
                                ...
                                <a class="legenda-em-auditoria" href="#"
                                    onclick="edit('<?= $BASE_URL ?>cad_capeante_audit.php?id_capeante=<?= $intern['id_capeante'] ?>')"><i
                                        style="color:#db5a0f; font-size: 1.1em; margin-left:5px;margin-right:5px"
                                        name="type" value="capeante" class="bi bi-file-text"> </i><span
                                        style="color:#db5a0f;">Analisar</span></a>
                                <?php } else { ?>
                                <a class="legenda-iniciar" href="#"
                                    onclick="edit('<?= $BASE_URL ?>cad_capeante_audit.php?id_capeante=<?= $intern['id_capeante'] ?>')"><i
                                        style="color:rgb(25, 78, 255); font-size: 1.1em; font-weight:bold; margin-left:5px;margin-right:5px"
                                        name="type" value="capeante" class="bi bi-file-text">
                                    </i><span>Iniciar</span></a>
                                <?php }
                                    else {; ?>
                                <a class="legenda-encerrado" href="#"><i
                                        style="color:black; text-decoration: none; font-size: 1.1em; font-weight:bold; margin-left:5px;margin-right:5px"
                ...
                <div style="display: flex;margin:10px 25px 25px 25px;">
