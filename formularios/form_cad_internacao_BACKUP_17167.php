...
<<<<<<< Updated upstream function triggerInternacaoAutoSave() { const form=document.getElementById('myForm'); if (!form)
    return; const submitBtn=form.querySelector('button[type="submit" ], input[type="submit" ]'); // impede salvar se
    houver campos obrigatórios faltando if (typeof form.checkValidity==='function' && !form.checkValidity()) {
    form.reportValidity && form.reportValidity(); return; } const restoreVisual=()=> {
    form.style.filter = '';
    form.style.opacity = '';
        ...
        <form class="visible" action="<?= $BASE_URL ?>process_internacao.php" id="myForm" method="POST"
            ...
            <div class="form-group row">
                ...
                <div class="form-group col-sm-1">
                    ...
                    <input type="date" value='<?= $dataAtual; ?>' class="form-control form-control-sm"
                        id="data_visita_int" name="data_visita_int">
            ...
            <div id="cadastro-central-wrapper" class="form-group row"
                ...
                <div class="form-group row align-items-end">
                    ...
                    <div class="form-group col-sm-4 d-none" id="box_resp_med">
                        ...
                        <select id="resp_med_id" class="form-control form-control-sm selectpicker"
                            data-live-search="true" data-size="5" title="Selecione">
                            <option value="">Selecione</option>
                    ...
                    <div class="form-group col-sm-5 d-none" id="box_resp_enf">
                        ...
                        <select id="resp_enf_id" class="form-control form-control-sm selectpicker"
                            data-live-search="true" data-size="5" title="Selecione">
                            <option value="">Selecione</option>
                    ...
                    <div id="div-detalhado" class="form-group row" style="margin-left:-12px">
                        <div class="form-group row">
                            ...
                            <div class="form-group col-sm-2">
                                ...
                                <select class="form-control-sm form-control" id="nivel_consc_det"
                                    name="nivel_consc_det">
                                    <option value="">Selecione</option>
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    ...
                                    <div class="form-check">
                                        <label style="margin-left:-30px" class="control-label"
                                            for="dreno_det">Dreno</label>
                        ...
                        <div class="form-group row" style="margin-top: -20px;">
                            ...
                            <div>
                                ...
                                <textarea data-saude-autocomplete="true" style="resize:none" maxlength="5000" rows="2"
                                    onclick="aumentarText('oportunidades_det')" class="form-control"
                                    id="oportunidades_det" onblur="reduzirText('oportunidades_det', 3)"
            ...
            <div class="tabelas-adicionais-card">
                ...
                <div class="form-group row d-flex justify-content-center align-items-end" style="gap: 15px;">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <select class="form-control-sm form-control select-purple" id="select_gestao"
                            name="select_gestao">
                            <option value="">Selecione</option>
                            <option value="s">Sim</option>
                            <option value="n">Não</option>
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <select class="form-control-sm form-control select-purple" id="select_negoc"
                            name="select_negoc">
                            <option value="">Selecione</option>
                            <option value="s">Sim</option>
                            <option value="n">Não</option>
