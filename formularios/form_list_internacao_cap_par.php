...
<div class="container-fluid listagem-page paradas-list-page" id="main-container">
    ...
    <div class="complete-table listagem-panel contas-filter-card">
...
$condicoes = [
    ...
    strlen((string)$senha_fin) ? 'conta_parada_cap = "' . $encerrado_cap . '"' : NULL,
