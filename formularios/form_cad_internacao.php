...
<div class="row">
    ...
    <div class="form-group row">
        <h4 class="page-title text-center w-100">Cadastrar internação</h4>
        <hr class="w-100">

        <div class="col-12 d-flex align-items-end flex-wrap justify-content-between">
            ...
            <div class="d-flex flex-wrap align-items-end" style="gap: 30px; flex: 2;">
                ...
                <div class="form-group mb-0" style="min-width: 300px;">
                    <label class="control-label" for="hospital_selected"><span style="color: red;">*</span>
                        Hospital</label>
    ...
    <form class="visible" action="<?= $BASE_URL ?>process_internacao.php" id="myForm" method="POST"
        ...
        <div class=" form-group row">
            ...
            <div class="form-group col-sm-4" style="margin-bottom:-25px">
            ...
            <div class="form-group row">
                ...
                <div>
                    ...
                    <textarea type="textarea" style="resize:none" maxlength="5000" rows="3"
                        onclick="aumentarText('exames_det')" onblur="reduzirText('exames_det', 3)" class="form-control"
                        id="exames_det" name="exames_det"></textarea>
                </div>
                <div>
