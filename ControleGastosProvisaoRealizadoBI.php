...
<div class="bi-wrapper bi-theme">
    <div class="bi-header">
        <h1 class="bi-title">Provisão vs Realizado</h1>
    ...
    <div class="bi-kpis kpi-compact kpi-tight kpi-slim">
        ...
        <div class="bi-kpi kpi-teal kpi-compact">
            <small>Realizado (final)</small>
            <strong>R$ <?= number_format($totalFinal, 2, ',', '.') ?></strong>
        </div>
        <div class="bi-kpi kpi-amber kpi-compact">
            <small>Desvio</small>
            <strong><?= number_format($desvio, 1, ',', '.') ?>%</strong>
        </div>
    </div>

    <div class="bi-panel">
        <h3>Provisão x Realizado (mensal)</h3>
        <div class="bi-chart"><canvas id="chartProvisao"></canvas></div>
    </div>
</div>
