...
$sql = "
    SELECT
        ...
        COUNT(*) AS casos,
        AVG(ca.valor_final_capeante) AS media_custo,
    ...
    WHERE {$where}
    GROUP BY h.nome_hosp, patologia
...
<div class="bi-wrapper bi-theme">
    <div class="bi-header">
        <h1 class="bi-title">Casos Caros Previsíveis</h1>
    ...
    <div class="bi-panel">
        <h3>Patologia + Hospital com maior custo médio</h3>
                    ...
                    <?php else: ?>
                        <?php foreach ($rows as $row): ?>
                            <tr>
                                ...
                                <td>R$ <?= number_format((float)($row['media_custo'] ?? 0), 2, ',', '.') ?></td>
