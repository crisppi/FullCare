...
$sqlBase = "
    ...
    {$utiJoin}
    JOIN tb_gestao g ON g.fk_internacao_ges = i.id_internacao AND g.opme_ges = 's'
...
$sqlTable = "
    SELECT
        ...
        COALESCE(NULLIF(g.rel_opme_ges,''), '-') AS relatorio
    {$sqlBase}
...
<div class="bi-wrapper bi-theme">
    <div class="bi-header">
        <h1 class="bi-title">Dashboard OPME</h1>
