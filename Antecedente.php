...
$sqlBase = "
    ...
    LEFT JOIN tb_antecedente an ON an.id_antecedente = i.fk_patologia2
...
$rowsDiárias = distQuery($conn, $labelAntecedente, $sqlBase, $params, "SUM(GREATEST(1, DATEDIFF(COALESCE(al.data_alta_alt, CURDATE()), i.data_intern_int) + 1))", 10);
$rowsMp = distQuery($conn, $labelAntecedente, $sqlBase, $params, "ROUND(AVG(GREATEST(1, DATEDIFF(COALESCE(al.data_alta_alt, CURDATE()), i.data_intern_int) + 1)), 1)", 10);
