...
// Negociação
if (file_exists(dirname(__DIR__, 2) . "/models/negociacao.php")) include_once("models/negociacao.php");
if (file_exists(dirname(__DIR__, 2) . "/dao/negociacaoDao.php")) include_once("dao/negociacaoDao.php");
