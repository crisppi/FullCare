...
$biSections = [
    'Resumo' => [
        ...
        ['label' => 'Indicadores Essenciais', 'href' => 'bi/indicadores-essenciais', 'file' => 'IndicadoresEssenciaisHubBI.php'],
        ['label' => 'Indicadores BI', 'href' => 'bi/indicadores', 'file' => 'Indicadores.php'],
    ],
    'Indicadores Essenciais' => [
        ['label' => 'Hub Essenciais', 'href' => 'bi/indicadores-essenciais', 'file' => 'IndicadoresEssenciaisHubBI.php'],
        ['label' => 'Contas Auditadas por Hospital', 'href' => 'bi/indicadores-essenciais/contas-auditadas-hospital', 'file' => 'IndicadoresEssenciaisItemBI.php'],
        ['label' => 'Custo Mensal por Hospital', 'href' => 'bi/indicadores-essenciais/custo-mensal-hospital', 'file' => 'IndicadoresEssenciaisItemBI.php'],
        ['label' => 'Glosa por Hospital', 'href' => 'bi/indicadores-essenciais/glosa-hospital', 'file' => 'IndicadoresEssenciaisItemBI.php'],
        ['label' => 'Contas Auditadas por Auditor', 'href' => 'bi/indicadores-essenciais/contas-auditadas-auditor', 'file' => 'IndicadoresEssenciaisItemBI.php'],
        ['label' => 'Glosa por Auditor', 'href' => 'bi/indicadores-essenciais/glosa-auditor', 'file' => 'IndicadoresEssenciaisItemBI.php'],
        ['label' => 'Saving por Hospital', 'href' => 'bi/indicadores-essenciais/saving-hospital', 'file' => 'IndicadoresEssenciaisItemBI.php'],
        ['label' => 'Saving por Auditor', 'href' => 'bi/indicadores-essenciais/saving-auditor', 'file' => 'IndicadoresEssenciaisItemBI.php'],
        ['label' => 'Custo por Patologia', 'href' => 'bi/indicadores-essenciais/custo-patologia', 'file' => 'IndicadoresEssenciaisItemBI.php'],
        ['label' => 'Custo por Antecedente', 'href' => 'bi/indicadores-essenciais/custo-antecedente', 'file' => 'IndicadoresEssenciaisItemBI.php'],
        ['label' => 'Custo por UTI', 'href' => 'bi/indicadores-essenciais/custo-uti', 'file' => 'IndicadoresEssenciaisItemBI.php'],
        ['label' => '% Internação UTI', 'href' => 'bi/indicadores-essenciais/percentual-internacao-uti', 'file' => 'IndicadoresEssenciaisItemBI.php'],
        ['label' => 'Eventos Adversos por Hospital', 'href' => 'bi/indicadores-essenciais/eventos-adversos-hospital', 'file' => 'IndicadoresEssenciaisItemBI.php'],
        ['label' => 'Óbitos por Hospital', 'href' => 'bi/indicadores-essenciais/obitos-hospital', 'file' => 'IndicadoresEssenciaisItemBI.php'],
        ['label' => 'Qualidade Hospitalar', 'href' => 'bi/indicadores-essenciais/qualidade-hospital', 'file' => 'IndicadoresEssenciaisItemBI.php'],
    ],
    'BI Estratégico' => [
...
:root {
    --bi-sidebar-top: 76px;
    --bi-sidebar-width: 218px;
    --bi-sidebar-collapsed-width: 50px;
    --bi-sidebar-content-gap: 10px;
}
...
.bi-side-toggle {
    position: fixed;
    left: calc(var(--bi-sidebar-width) - 30px);
    top: calc(var(--bi-sidebar-top) + 6px);
    z-index: 1202;
    width: 28px;
    height: 28px;
...
.bi-sidebar-shell {
    ...
    box-shadow: 10px 0 24px rgba(5, 20, 34, 0.24);
...
.bi-sidebar-search-box {
    ...
    height: 30px;
    border-radius: 7px;
    border: 1px solid rgba(127, 243, 222, 0.56);
...
.bi-sidebar-search-box:focus-within {
    ...
    box-shadow: inset 2px 0 0 rgba(127, 243, 222, 0.95), 0 0 0 2px rgba(99, 213, 192, 0.14), 0 0 12px rgba(99, 213, 192, 0.08);
}
...
.bi-sidebar-group {
    ...
    box-shadow: 0 6px 14px rgba(3, 20, 36, 0.14), inset 0 1px 0 rgba(255, 255, 255, 0.08);
    overflow: hidden;
}
...
.bi-sidebar-group.is-active .bi-sidebar-dot {
    background: #63d5c0;
    box-shadow: 0 0 0 4px rgba(99, 213, 192, 0.14), 0 0 12px rgba(99, 213, 192, 0.28);
}

.bi-sidebar-group[open]:not(.is-active) .bi-sidebar-dot {
    background: #9fc4de;
    box-shadow: 0 0 0 3px rgba(159, 196, 222, 0.13);
}
...
.bi-topbar-select:focus {
    ...
    box-shadow: 0 6px 14px rgba(4, 17, 31, 0.24), 0 0 0 2px rgba(99, 213, 192, 0.10);
}
...
body.bi-theme.bi-nav-collapsed .bi-sidebar-group {
    ...
    box-shadow: 0 5px 12px rgba(3, 20, 36, 0.14), inset 0 1px 0 rgba(255, 255, 255, 0.09);
}
