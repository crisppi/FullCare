...
<head class='fc-headerfull-inline-1'>
    <meta charset="utf-8">
    ...
    <link href="<?= $BASE_URL ?>css/header_full_layout.css?v=<?= @filemtime(__DIR__ . '/../css/header_full_layout.css') ?>" rel="stylesheet">
...
<body>
    <div class="col-md-12">
        <div class="bar_color fc-headerfull-inline-27">
        </div>
        <nav class="navbar navbar-expand-lg navbar-light bg-light nav_bar_custom">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php">
                    <img src="img/full-03.png" alt="Full" class='fc-headerfull-inline-2'>
                ...
                <div>
                    <h3 class="titulo_header fc-headerfull-inline-3">Sistema Gestão</h3>
                </div>
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="nav-tabs navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll fc-headerfull-inline-4"
                       >
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                <li><a class="dropdown-item" href="<?= $BASE_URL ?>menu_app.php"><i
                                            class="bi bi-person fc-headerfull-inline-5"
                                           ></i>
                                        Status</a></li>
                                <li><a class="dropdown-item" href="<?= $BASE_URL ?>menu"><span
                                            class="bi bi-hospital fc-headerfull-inline-6"
                                           ></span>
                                        Menu</a></li>
                            </ul>
                        </li>
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                  <li><a class="dropdown-item" href="<?php $BASE_URL ?>cad_paciente.php"><span class="bi bi-person fc-headerfull-inline-7"></span> Paciente</a></li>
                  <li><a class="dropdown-item" href="<?php $BASE_URL ?>cad_hospital.php"><span class="bi bi-hospital fc-headerfull-inline-5"></span> Hospital</a></li>
                  <li><a class="dropdown-item" href="<?php $BASE_URL ?>cad_seguradora.php"><span class="bi bi-heart-pulse fc-headerfull-inline-8"></span> Seguradora</a></li>
                  <li><a class="dropdown-item" href="<?php $BASE_URL ?>cad_estipulante.php"><span class="bi bi-building fc-headerfull-inline-9"></span> Estipulante</a></li>
                  <li>
                    <hr class="dropdown-divider">
                  </li>
                  <li><a class="dropdown-item" href="<?php $BASE_URL ?>cad_acomodacao.php"><span class="bi bi-clipboard-heart fc-headerfull-inline-10"></span> Acomodação</a></li>
                  <li><a class="dropdown-item" href="<?php $BASE_URL ?>cad_patologia.php"><span class="bi bi-virus fc-headerfull-inline-10"></span> Patologia</a></li>
                  <li><a class="dropdown-item" href="<?php $BASE_URL ?>cad_antecedente.php"><span class="bi bi-people fc-headerfull-inline-10"></span> Antecedente</a></li>
                </ul>
              </li> -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                ...
                                <li><a class="dropdown-item" href="<?= $BASE_URL ?>seguradoras"><span
                                            class=" bi bi-heart-pulse fc-headerfull-inline-11"
                                           ></span>
                                        Seguradoras</a></li>
                                <li><a class="dropdown-item" href="<?= $BASE_URL ?>estipulantes"><i
                                            class="bi bi-building fc-headerfull-inline-12"
                                           ></i>
                                        Estipulantes</a></li>
                                ...
                                <li><a class="dropdown-item" href="<?= $BASE_URL ?>list_usuario.php"><i
                                            class="bi bi-people-fill fc-headerfull-inline-13"
                                           ></i>
                                        Usuários</a></li>
                                <?php } ?>
                                <li>
                                ...
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>list_patologia.php"><span
                                            class=" bi bi-virus fc-headerfull-inline-14"
                                           ></span>
                                        Patologia</a></li>
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>list_antecedente.php"><i
                                            class="bi bi-people fc-headerfull-inline-11"
                                           ></i>
                                        Antecedente</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>censo/novo"><i
                                            class="bi bi-book fc-headerfull-inline-5"
                                           ></i>
                                        Cadastro Censo</a></li>
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>list_censo_adm.php"><i
                                            class="bi bi-book fc-headerfull-inline-15"
                                           ></i>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                <!-- <li><a class="dropdown-item" href="<?php $BASE_URL ?>censo/novo"><i class="bi bi-book fc-headerfull-inline-5"></i> Cadastro Censo</a></li> -->
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>internacoes/nova"><i
                                            class="bi bi-calendar2-date fc-headerfull-inline-5"
                                           ></i> Nova
                                        Internação</a></li>
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>internacoes/lista"><i
                                            class="bi bi-pencil-square fc-headerfull-inline-5"
                                           ></i>
                                        Visita</a></li>
                                <li>
                                <li>
                                ...
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>internacoes/lista"> <i
                                            class="bi bi-calendar2-date fc-headerfull-inline-16"
                                           ></i> Lista
                                        Internação</a></li>
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>list_internacao_uti.php"> <i
                                            class="bi bi-clipboard-heart fc-headerfull-inline-16"
                                           ></i> Lista
                                        Internação UTI</a>
                                </li>
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>list_gestao.php"><i
                                            class="bi bi-postcard-heart fc-headerfull-inline-16"
                                           ></i> Lista
                                        Gestão</a></li>
                                ...
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>list_internacao_uti_alta.php"><span
                                            id="boot-icon3" class="bi bi-box-arrow-left fc-headerfull-inline-17"
                                           ></span>
                                        Alta UTI</a></li>
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>list_internacao_alta.php"><span
                                            id="boot-icon3" class="bi bi-box-arrow-left fc-headerfull-inline-18"
                                           ></span>
                                        Alta Hospitalar</a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                ...
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>list_prorrogacao_pendente.php"><i
                                            class="bi bi-hourglass-split fc-headerfull-inline-19"
                                           ></i>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>list_internacao_cap.php"><span
                                            id="boot-icon1" class="bi bi-currency-dollar fc-headerfull-inline-20"
                                           >
                                ...
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>list_internacao_cap_fin.php"> <span
                                            id="boot-icon" class="bi bi-shield-check fw-bold fc-headerfull-inline-21"
                                           > </span>
                                        Contas Finalizadas
                                    </a></li>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                <li><a class="dropdown-item"
                                        href="<?php $BASE_URL ?>list_internacao_patologia.php"><span id="boot-icon1"
                                            class="bi bi-capsule-pill fc-headerfull-inline-20"
                                           > </span>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                <li><a class="dropdown-item" href="<?php $BASE_URL ?>relatorios.php"><span
                                            id="boot-icon1" class="bi bi-clipboard-data fc-headerfull-inline-20"
                                           >
            ...
            <div class="col-md-2 fc-headerfull-inline-22">

                <?php
        if ($_SESSION) {
          echo "<span class='fc-headerfull-inline-23'>Bem vindo: " . $_SESSION['email_user'] . "</span><br>";
          $agora = date('d/m/Y H:i');
        } else {
          echo "<span class='fc-headerfull-inline-24'> Você não esta logado!</span>" . "<br>";
        }
        $agora = date('d/m/Y H:i');
        echo "<div >";
        echo "<span class='fc-headerfull-inline-25'>Data: " . $agora;
        ?>

                <div class='fc-headerfull-inline-26'>
                    <a class="dropdown-item fc-headerfull-inline-28"
